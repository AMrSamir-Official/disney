...
export const TvDetails = [
  {
    ...
    Certificate: "15",
    Description:
      "*random text* Savitri, the matriarch of a massive cartel in the lawless Borderlands, opens up a battle for succession to find her heir in a murky world of drugs and violence.",
  ...
  },
  {
    ...
    Certificate: "15",
    Description:
      "*random text*A hotel's night manager is the only weapon against a dangerous arms dealer. Will he be able to stop him?",
    Genre: "Thriller | Drama ",
    Image: tv4banner,
    url: "6QJQysiUxKc",
  },
